...
Major insights gathered through in-depth interviews were quickly weighed based on the lean framework of “Leap of Faith”. The aim is to define a problem hypothesis that no further experimentation that can be feasibly conducted and pushed us to take a leap of faith.

For example, one thing I learnt from the process of understanding the customers was that a traveler plans to derive a sense of assurance so that time will be well spent during the travel. However, planning did not guarantee a satisfactory travel experience. As I reviewed the many recounts, I observed in planners a half-cup empty mindset when they recollect about their trip. They focused a lot on what they couldn't complete on the trip and lamented about a sense of unfulfillment where they felt that they never fully explored the place. On the contrary, travelers who ‘went with the wind’ went away with a greater sense of fulfillment despite spontaneous travel decision and recommendations by locals.

Upon uncovering this insight, it was hard to organize for further interviews to map out planning models and behaviors. I was pressed for time as a solo founder and wearing multiple hats to keep the startup afloat. Adopting the lean model, I was able to transit from research to product features design quickly be running experiments. We let a set of test users choose between a planning tool versus a planning process with a guide using the tool and 85% of the users chose to speak with an individual to get insights on what to do on the trip.

To clarify, this decision was made in a span of 2 days and the idea was to validate and kill our best ideas as quickly as possible as part of the agile development model. Now, this process guided my decision to skip the process of building a better research tool to help plan trips but jump straight into connecting the travelers with local guides through a chat interface.

Throughout the research process, more than 100 stakeholders and customers were interviewed and dozens of lean experimentation were conducted to validate the customer and problem hypothesis to form our solution and MVP design.
